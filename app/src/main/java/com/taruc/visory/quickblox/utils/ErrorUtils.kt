...
private val NO_CONNECTION_ERROR = App.getInstance().getString(R.string.qb_connection_error)
private val NO_RESPONSE_TIMEOUT = App.getInstance().getString(R.string.qb_connection_timeout)

private val NO_INTERNET_CONNECTION = App.getInstance().getString(R.string.qb_no_connection)
